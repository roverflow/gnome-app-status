...
class IndicatorBaseStatusIcon extends St.Widget {
    _init(nameText, iconActor) {
        super._init({
            reactive: true,
            can_focus: true,
            track_hover: true,
        ...
        this.menu.actor.add_style_class_name('appstatus-menu');
...
class IndicatorStatusIcon extends BaseStatusIcon {
    _init(indicator) {
        super._init(indicator.accessibleName,
